#!/usr/bin/env python3
"""
Segmentation model hooks and trainer for Detectron2
"""
...
class BestModelHook(HookBase):
    ...
    def __init__(self, cfg, eval_period, patience=10):
        ...
        Args:
            ...
            eval_period: Evaluation period in iterations
    ...
    def get_valid_score(self, segm_results):
        """
        Get valid evaluation score, ignoring -1 values.
        
        Args:
            segm_results: Segmentation results dictionary
...
class SegmentationTrainer(DefaultTrainer):
    """Custom trainer for segmentation with early stopping."""
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        """Build evaluator for segmentation."""
    ...
    def build_hooks(self):
        ...
        try:
            ...
            # Use estimated value if exact count fails
            iters_per_epoch = 127
    ...
    def run_step(self):
        """Override run_step to support early stopping."""
        super().run_step()
    ...
    def train(self):
        """Override train method to add summary."""
        super().train()
