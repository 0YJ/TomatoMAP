...
# add project and local module paths
...
Examples:
  ...
  python main.py seg vis --n 5
    ...
    det_parser.add_argument('--data-config', type=str, default='configs/det/TomatoMAP-Det.yaml',
                           help='Path to data configuration file (default: configs/det/TomatoMAP-Det.yaml)')
